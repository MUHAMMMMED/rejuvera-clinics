...
from ..serializers import ServiceProblemSolutionWriteSerializer
...
class ServiceProblemSolutionViewSet(ModelViewSet):
    permission_classes = [IsAuthenticated] 
    queryset = ServiceProblemSolution.objects.all()
    serializer_class = ServiceProblemSolutionWriteSerializer
